...
Built by [Abdullah Abdelwahab](https://github.com/abdelwb) as a demonstration of hands-on experience with LangChain, the Hugging Face ecosystem, vLLM, SGLang, PyTorch, TensorFlow, and scikit-learn. MIT licensed (see [`LICENSE`](LICENSE)).
